    ...
    case 0x2000:  /* PPU */
      switch ( wAddr & 0x7 )
      {
        case 0:    /* 0x2000 */
		  ...
		  loopy_t = (loopy_t & 0xF3FF)|(((WORD)byData & 0x03)<<10);
          break;
        ...
        case 5:   /* 0x2005 */
          ...
          if ( PPU_Latch_Flag )
          {
			  ...
			  loopy_t = (loopy_t & 0xFC1F)|((((WORD)byData) & 0xF8)<<2);
			  // scroll offset Y t:0111000000000000=d:00000111
			  loopy_t = (loopy_t & 0x8FFF)|((((WORD)byData) & 0x07)<<12);
          ...
          else
          {
			  ...
			  loopy_t = (loopy_t & 0xFFE0)|(((WORD)byData)>>3);
        ...
        case 6:   /* 0x2006 */
          ...
          if ( PPU_Latch_Flag )
          {
			  ...
			  loopy_t = (loopy_t & 0xFF00)|(WORD)byData;
			  // v=t
			  loopy_v = loopy_t;
		  ...
		  else
		  {
			  ...
			  loopy_t = (loopy_t & 0x00FF)|((((WORD)byData) & 0x3F)<<8);
          }
          PPU_Latch_Flag ^= 1;
          break;
