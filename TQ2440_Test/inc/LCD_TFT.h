...
extern  unsigned char A65[];
extern  unsigned char B65[];
extern  unsigned char q65[];
extern  unsigned char S65[];
extern  unsigned char slect[];
extern  unsigned char slect2[];
extern  unsigned char logo[];
extern  unsigned char logo2[];
extern  unsigned char logo3[];
extern  unsigned char hundouluo[];
extern  unsigned char mali[];
extern  unsigned char chiyingzhanshi[] ;
extern  unsigned char gongfu[];
extern  unsigned char kuailemao[];
extern  unsigned char luokeren[] ;
extern  unsigned char shamantuo[];
extern  unsigned char weilaizhanshi[];
extern  unsigned char gonglusaiche[];
extern  unsigned char xiaomeiren[];
extern  unsigned char bingfeng[];
extern  unsigned char chaiwugong[];
extern  unsigned char chenglongtiguan[];
extern  unsigned char chenglongzhi[];
extern  unsigned char chidou[];
extern  unsigned char chongqigou[] ;
extern  unsigned char huojianche[];
extern  unsigned char kelami[];
extern  unsigned char lvsebing[] ;
extern  unsigned char maoxiandao[] ;
extern  unsigned char maoxiandao4[];
extern  unsigned char zhonghuadaxian[];
extern  unsigned char maxituan[];
extern  unsigned char qie[];
extern  unsigned char ranshao[];
extern  unsigned char threepig[];
//extern  unsigned char yueye[];

//extern  unsigned char eluosi[];
