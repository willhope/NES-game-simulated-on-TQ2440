...
void Port_Init(void)
{
    ...
    //Binary :   10   ,  10     10 , 11    11  , 10   10 , 10   10 , 10    10
    rGPHCON = 0x00faaa;
    rGPHUP  = 0x7ff;    // The pull up function is disabled GPH[10:0]  x`
...
//UART0
    ...
    rUBRDIV0=( (int)(pclk/16./9600+0.5) -1 );   //Baud rate divisior register 0
//UART1
    rULCON1 = 0x3;
    rUCON1  = 0x245;
    rUBRDIV1=( (int)(pclk/16./9600+0.5) -1 );
//UART2
    rULCON2 = 0x3;
    rUCON2  = 0x245;
    rUBRDIV2=( (int)(pclk/16./9600+0.5) -1 );    
...
{
	ClearSubPending(BIT_SUB_RXD1|BIT_SUB_TXD1|BIT_SUB_ERR1);
    
    ClearPending(BIT_UART1);
    EnableIrq(BIT_UART1);
	EnableSubIrq(BIT_SUB_RXD1|BIT_SUB_ERR1);
   // rINTSUBMSK=~(BIT_SUB_RXD1|BIT_SUB_ERR1);
	
	pISR_UART1 = (U32)uart_interrupt; 
}
...
void Uart0_irq_init(void)
{
    ...
    EnableIrq(BIT_UART0);
	EnableSubIrq(BIT_SUB_RXD0|BIT_SUB_ERR0);
   // rINTSUBMSK=~(BIT_SUB_RXD1|BIT_SUB_ERR1);
...
/*	rSUBSRCPND |=7;
	...
	if(buf[2]=='1'&&buf[3]=='2')
		...
		else if(buf[2]=='1'&&buf[3]=='3')
		//Uart_Printf("down\n");
		joy = PAD_JOY_DOWN;

		else if(buf[2]=='1'&&buf[3]=='4')
		//Uart_Printf("left\n");
		joy = PAD_JOY_LEFT;

		else if(buf[2]=='1'&&buf[3]=='5')
		//Uart_Printf("right\n");
		joy = PAD_JOY_RIGHT;
